...
public class BlockCedarLeaves extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"cedar"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_cedar"}, {"leaves_cedar_opaque"}};
    ...
    public BlockCedarLeaves(int par1)
    {
