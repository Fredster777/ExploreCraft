...
public class BlockCedarLog extends BlockRotatedPillar
{
    public BlockCedarLog(int par1, Material par2Material) {
    ...
    protected BlockCedarLog(int par1)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[i] = par1IconRegister.registerIcon("ExploreCraft:log_" + woodType[i]);
            this.tree_top[i] = par1IconRegister.registerIcon("ExploreCraft:log_" + woodType[i] + "_top");
        }
    }
